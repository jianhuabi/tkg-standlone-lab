...
export DO_KCLUSTER_ID=$(doctl k cluster list | grep $MANAGEMENT_CLUSTER_NAME | awk '{ print $1 }')
...
tanzu package repository add tanzu-standard --url projects.registry.vmware.com/tkg/packages/standard/repo:v1.5.0  --namespace tanzu-kapp --create-namespace
