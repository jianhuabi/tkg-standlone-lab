...
cp tkg-extensions-mods-examples/registry/harbor/03-certs.yaml generated/$SHAREDSVC_CLUSTER_NAME/harbor/03-certs.yaml 
yq e -i ".spec.commonName = env(HARBOR_CN)" generated/$SHAREDSVC_CLUSTER_NAME/harbor/03-certs.yaml 
yq e -i ".spec.dnsNames[0] = env(HARBOR_CN)" generated/$SHAREDSVC_CLUSTER_NAME/harbor/03-certs.yaml 
yq e -i ".spec.dnsNames[1] = env(NOTARY_CN)" generated/$SHAREDSVC_CLUSTER_NAME/harbor/03-certs.yaml 
kubectl apply -f generated/$SHAREDSVC_CLUSTER_NAME/harbor/03-certs.yaml 
